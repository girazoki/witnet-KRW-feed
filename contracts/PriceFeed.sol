...
// Import the KRW-BTC request that you created before
import "./requests/krwFeed.sol";

// Your contract needs to inherit from UsingWitnet
contract PriceFeed is UsingWitnet {
  int128 public krwPrice; // The public KRW-BTC price point
